...
bool test_parseLine() {
    ...
    char line2[] = "California,CA,55,10783669\n"; 
    char line3[] = "Texas,TX,38,6612313";            
    char line4[] = "New York,NY,29,";                   
    char line5[] = ",CA,55,10783669";                   
    char line6[] = "Florida,,,20201234";                
    char line7[] = "Virginia,VA,13,";                    
    char line8[] = "NotEnoughCommas";                   
    char line9[] = "Too,many,commas,in,this,line";       
    char line10[] = "";
    ...
    if (!result1 || !result2 || !result3 || !result4 || !result5 || !result6 || !result7) return false;

    if (result8 || result9 || result10) return false;
